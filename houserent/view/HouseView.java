package ProjectExercise.houserent.view;

import ProjectExercise.houserent.domain.House;
import ProjectExercise.houserent.service.HouseService;
...
public class HouseView {
    ...
    //编写delHouse()，接收输入的id，调用 Service的del方法
    public void delHouse() {
        ...
        char choice = ' ';
        while (true) {
            System.out.println("确认要删除该房屋信息吗？（y/n）");
    ...
    public void listHouses() {
        ...
        for (int i = 0; i < houses.length; i++) {
            //实际保存的房屋信息个数可能小于houses.length
            if (houses[i] == null) {//如果为空，就不用显示
                break;
            }
